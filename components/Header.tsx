...
export default function Header() {
  ...
  return (
    <header className="flex flex-col md:flex-row bg-walmart  px-10 py-7 space-x-5 items-center">
      ...
      <div
        className="flex space-x-5 text-white mt-5 md:mt-0 font-bold
">
        <Link
          href="/"
          className="hidden xl:flex items-center space-x-2 text-sm">
          <Grid2X2 size={20} />
          <p>Departments</p>
        </Link>
        <Link
        ...
        <Link href="/basket" className=" flex space-x-5 items-center">
